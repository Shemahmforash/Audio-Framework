...
public class ExamplePeaksWithoutPlot {
	...
	//public static final String FILE = "/home/wanderer/samples/cutted/hidden-flame.mp3";
	
	public static final String FILE = "/home/wanderer/samples/cutted/6-three.mp3";
	
	//public static final String FILE = "/home/wanderer/samples/pedro/cranberries_-_zombie.wav";
	...
	public static void main(String[] args) throws FileNotFoundException, Exception {
		...
		ArrayList<Double> onsets = peaks.getPeaksAsInstantsInTime(512, 44100);
		
		/*for(int i = 0; i < peaks.getPeaks().size(); i++) {
			if(peaks.getPeaks().get(i) > 0) {
				onsets.add((double)(i * 1024.0/44100.0));
				
			}
				
			System.out.println("onset(" + i + ") = " + (double)(i * 1024.0/44100.0));
		}*/
